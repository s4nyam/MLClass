# -*- coding: utf-8 -*-
"""(0 hidden Layer Architecture)Familiarization with Tensorflow.ipynb
...
prbs = tf.nn.softmax (tf.matmul(img, W)+b) # Affine transformation
...
"""# For 1000 updates test accuracy = ~91.59%"""
...
"""# for 10000 updates test accuracy = ~93%"""
...
print("For 10000 updates Test accuracy: %r" % (sumAcc/1000))
...
print("For 10000 updates Test accuracy: %r" % (sumAcc/10000))
